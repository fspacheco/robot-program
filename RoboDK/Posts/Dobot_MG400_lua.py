...
# From https://robodk.com/forum/Thread-driver-and-a-post-processor-of-Dobot-Arm-MG400
# Updated by Fernando S. Pacheco 2024
# ----------------------------------------------------
# This file is a POST PROCESSOR script to generate programs
# for MG400 robot with RoboDK. Output is a Lua script
#
...
# ----------------------------------------------------
def pose_2_str(pose):
    """Convert a robot pose target to a string according to the syntax/format of the controller.
...
def joints_2_str(joints):
    """Convert a robot joint target to a string according to the syntax/format of the controller.
...
class RobotPost(object):
    ...
    def __init__(self, robotpost=None, robotname=None, robot_axes=4, **kwargs):
        ...
        if show_result:
            if type(show_result) is str:
                ...
                if os.name=='nt': # nt is windows
                    ...
                    import subprocess
                    subprocess.call(["open", filesave])
            self.addlog(f'Saved {filesave}')
            if len(self.LOG) > 0:
    ...
    def MoveL(self, pose, joints, conf_RLF=None):
        ...
        **Tip**:
        ...
        :type conf_RLF: int list
        """
        self.addline('MovL({armOrientation="right", coordinate={' + pose_2_str(pose) + '}, tool=0, user=0 }, Default_Option)')
    ...
    def MoveC(self, pose1, joints1, pose2, joints2, conf_RLF_1=None, conf_RLF_2=None):
        ...
        **Tip**:
        ...
        """
        self.addline('MovC(' + pose_2_str(pose1) + ', ' + pose_2_str(pose2) + ', Default_Option)')
    ...
    def Pause(self, time_ms):
        ...
        **Tip**:
        ...
        """
        if time_ms < 0:
            self.addline('Wait(1)  --sleep very short time')
        else:
            self.addline('Wait(%d)' % (time_ms))
    ...
    def setDO(self, io_var, io_value):
        ...
        **Tip**:
        ...
        if type(io_var) == str and type(io_value) == str:
            self.addline('DO(%s,%s)' % (io_var, io_value))
